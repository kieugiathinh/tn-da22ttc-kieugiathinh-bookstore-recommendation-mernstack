  ...
  return (
    <div
      className="bg-white p-3 rounded-2xl border border-slate-100 cursor-pointer relative group h-full flex flex-col
                 ...
                 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-orange-500/20
    ...
    >
      ...
      <Link to={`/product/${product._id}`} className="flex-1 flex flex-col">
        ...
        {/* Tên sách */}
        <h3 className="text-sm font-medium text-slate-700 line-clamp-2 mb-2 min-h-[40px] group-hover:text-orange-600 transition-colors duration-200">
          {product.title}
        </h3>
