...
const getEmailHeader = () => `
  <div style="background: linear-gradient(135deg, #991b1b 0%, #7f1d1d 100%); padding: 32px 24px; text-align: center; border-radius: 12px 12px 0 0;">
    <div style="display: inline-block; margin-bottom: 12px;">
      <span style="font-size: 36px;">🐝</span>
    </div>
    <h1 style="margin: 0; font-size: 28px; font-weight: 800; color: #ffffff; letter-spacing: 1px;">
      Book<span style="color: #F59E0B;">Bee</span>
    </h1>
    <p style="margin: 6px 0 0; font-size: 13px; color: #fca5a5; letter-spacing: 2px; text-transform: uppercase;">
  ...
  const content = `
    <div style="padding: 36px 32px;">
      ...
      <p style="margin: 0 0 24px; font-size: 15px; color: #57534e; line-height: 1.7;">
        Cảm ơn bạn đã gia nhập cộng đồng <strong style="color: #991b1b;">BookBee</strong>. 
      ...
      <div style="background: linear-gradient(135deg, #fffbeb 0%, #fef3c7 100%); border: 2px dashed #F59E0B; border-radius: 12px; padding: 28px 24px; text-align: center; margin: 24px 0;">
        ...
        <p style="margin: 0 0 16px; font-size: 14px; color: #78350f;">
          Giảm <strong style="font-size: 18px; color: #991b1b;">10%</strong> cho đơn hàng đầu tiên
        </p>
        <div style="display: inline-block; background: #991b1b; color: #F59E0B; font-size: 24px; font-weight: 800; letter-spacing: 4px; padding: 14px 32px; border-radius: 8px; border: 2px solid #7f1d1d;">
          WELCOMEBEE
        </div>
      ...
      <div style="text-align: center; margin: 32px 0 8px;">
        <a href="${process.env.CLIENT_URL}" 
           style="display: inline-block; background: linear-gradient(135deg, #991b1b 0%, #b91c1c 100%); color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 700; padding: 14px 40px; border-radius: 8px; letter-spacing: 0.5px; box-shadow: 0 4px 14px rgba(153,27,27,0.3);">
          Khám phá ngay →
        </a>
      </div>
    </div>
  ...
  const content = `
    <div style="padding: 36px 32px;">
      ...
      <div style="text-align: center; margin: 28px 0;">
        <a href="${resetUrl}" 
           style="display: inline-block; background: linear-gradient(135deg, #991b1b 0%, #b91c1c 100%); color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 700; padding: 16px 48px; border-radius: 8px; letter-spacing: 0.5px; box-shadow: 0 4px 14px rgba(153,27,27,0.35);">
          🔑 Đặt lại mật khẩu
        </a>
      </div>
