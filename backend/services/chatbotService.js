...
const SYSTEM_PROMPT = `Bạn là nhân viên tư vấn của nhà sách BookBee – một nhà sách trực tuyến uy tín.
...
Hãy trả lời dựa HOÀN TOÀN vào danh sách sách ở trên. Nhớ ngữ cảnh cuộc trò chuyện trước đó.`;
    ...
    const botReply =
      ...
      "Xin lỗi, BookBee tạm thời không thể trả lời. Bạn vui lòng thử lại nhé! 🙏";
