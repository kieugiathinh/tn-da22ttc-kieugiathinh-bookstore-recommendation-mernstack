...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl w-full bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[550px] z-10 relative">
        {/* --- CỘT TRÁI: TYPOGRAPHY --- */}
          ...
          <div className="relative z-10 text-center flex flex-col items-center w-full">
            ...
            <div className="relative max-w-md px-6">
              ...
              <p className="text-lg font-medium italic opacity-90 leading-relaxed">
                "Bảo mật tài khoản là ưu tiên hàng đầu của chúng tôi. Hãy tạo
                một mật khẩu mạnh để bảo vệ kho sách của bạn."
              </p>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white">
          ...
          <div className="mb-10">
            ...
            <p className="mt-3 text-gray-500 font-medium text-sm leading-relaxed">
              Tạo mật khẩu mới cho tài khoản BookBee của bạn. Mật khẩu phải có
              ít nhất 6 ký tự.
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              {confirmPassword && confirmPassword !== newPassword && (
                <p className="text-xs text-red-500 font-semibold ml-1 mt-1">
                  ⚠ Mật khẩu xác nhận không khớp
                </p>
              )}
              {confirmPassword && confirmPassword === newPassword && (
                <p className="text-xs text-green-500 font-semibold ml-1 mt-1">
                  ✓ Mật khẩu khớp
                </p>
              )}
            </div>
